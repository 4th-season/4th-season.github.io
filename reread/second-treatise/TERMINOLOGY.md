...
| prerogative | 대권 | 법률의 명시적 규정 밖에서 공익을 위해 행사하는 재량 |
...
- `express consent`는 완전한 구성원 자격을 만드는 **명시적 동의**, `tacit consent`는 토지·영토·보호를 누리는 동안 법에 복종하게 하는 **묵시적 동의**로 구분한다.
- 묵시적 동의에 따른 복종과 정치공동체의 영구적 구성원 자격을 동일시하지 않는다.
